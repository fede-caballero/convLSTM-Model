...
def crear_carpetas_mdv(ruta_base):
    ...
    nuevas_carpetas = math.ceil(total_archivos_sueltos / 25)
...
def main():
    campaña = "Classified"
    carpeta_base = "20170328"
    ruta_especifica = f"/home/f-caballero/UM/TIF3/convLSTM-project/convLSTM-Model/netCDF_samples/Big-Sample-New/{campaña}/{carpeta_base}"
